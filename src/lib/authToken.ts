...
// supabase/functions/workos). Mirrors the sibling `portfolio` project's
// src/lib/adminAuthToken.ts.
 ...
 *  real verification always happens server-side in the workos Edge Function. */
